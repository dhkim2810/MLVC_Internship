...
class InceptionStem(self, num_channels=10):
    def __init__(self, x):
        ...
        self.Conv2d_1 = BasicConv2d(3, 32, kernel_size=3, stride=1, padding=1)
        ...
        self.Conv2d_6b_7x1 = BasicConv2d(64, 64, kernel=(7,1), padding=(3,0))
        self.Conv2d_6c_1x7 = BasicConv2d(64, 64, kernel=(1,7), padding=(0,3))
        self.Conv2d_6d_3x3 = BasicConv2d(64, 96, kernel=3)
        self.Conv2d_7 = BasicConv2d(192, 192, kernel_size=3, stride=1, padding=1)
...
class InceptionA(self, in_channels):
...
class InceptionB(self, in_channels):
    def __init__(self, in_channels):
        super(InceptionB, self).__init__()
        self.branch1x1 = BasicConv2d(in_channels, 128, kernel_size=1)

        self.branch7x7_1 = BasicConv2d(in_channels,192, kernel_size=1)
        self.branch7x7_2 = BasicConv2d(192, 224, kernel=(1,7), padding=(0,3))
        self.branch7x7_3 = BasicConv2d(224, 256, kernel=(7,1), padding=(3,0))

        self.branch9x9_1 = BasicConv2d(in_channels, 192, kernel_size=1)
        self.branch9x9_2 = BasicConv2d(192, 192, kernel=(1,7), padding=(0,3))
        self.branch9x9_3 = BasicConv2d(192, 224, kernel=(7,1), padding=(3,0))
        self.branch9x9_4 = BasicConv2d(224, 224, kernel=(1,7), padding=(0,3))
        self.branch9x9_5 = BasicConv2d(224, 224, kernel=(7,1), padding=(3,0))
...
class InceptionC(self, in_channels):
    def __init__(self, in_channels):
...
class ReductionA(self, in_channels):
    def __init__(self,in_channels):
        super(ReductionA, self).__init__()
        self.branch3x3 = BasicConv2d(in_channels, 384, kernel_size=3, stride=1, padding=1)

        self.branch5x5_1 = BasicConv2d(in_channels, 192, kernel_size=1)
        self.branch5x5_2 = BasicConv2d(192, 224, kernel=3, padding=1)
        self.branch5x5_3 = BasicConv2d(224, 256, kernel=3, stride=1, padding=1)
...
class ReductionB(self, in_channels):
    def __init__(self, in_channels):
        super(ReductionB, self).__init__()
        self.branch3x3_1 = BasicConv2d(in_channels, 192, kernel_size=1)
        self.branch3x3_2 = BasicConv2d(192, 192, kernel_size=3, stride=1, padding=1)

        self.branch7x7_1 = BasicConv2d(in_channels, 256, kernel_size=1)
        self.branch7x7_2 = BasicConv2d(256, 256, kernel=(1,7), padding=(0,3))
        self.branch7x7_3 = BasicConv2d(256, 320, kernel_size=(7,1), padding=(3,0))
        self.branch7x7_4 = BasicConv2d(320, 320, kernel_size=3, stride=1, padding=1)
